...
public class Categoria implements Serializable{
	...
	@JsonManagedReference //para o requestmapping na categoriaresource não fazer um loop infinito entre as listas de categoria e produto e retornar os objectos associados a produtos e quando chegar à anotação JsonBackReference omitir a lista de catogorias para cada produto 
