...
public class DBService {
	...
	public void instantiateDataBase() throws ParseException {
		...
		p1.getCategorias().addAll(Arrays.asList(cat1, cat4));// Associação entre categorias e produtos
		...
		Cliente cli2 = new Cliente(null, "Ana Sofia", "Ana@gmail.com", "66365052065",
				TipoCliente.PESSOAFISICA, pe.encode("1234"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("27762227", "93878797"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apt 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floreano", "206", null, "Centro", "28177012", cli2, c2);
